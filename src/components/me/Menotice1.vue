<template>
  ...
  <div class="lbj_wrap">
    ...
    <!-- 内容部分 -->
    <!-- 有数据 -->
    <div class="lbj_shuj" v-if="lbjKecTz.length>0==show">
      <div class="lbj_item" v-for="(item) in lbjKecTz" :key="item.id">
  ...
  methods: {
    ...
    lbjlessTz() {
      getTzo({
        ...
        console.log(res);
        this.lbjKecTz=res.data.data.list
      });
    }
  }
};
